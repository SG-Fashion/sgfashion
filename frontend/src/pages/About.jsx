...
const About = () => {
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row text-md pb-10'>
          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
            <b>Authentic Designs:</b>
            <p className='text-gray-800'>Every drop tells a story. We design with originality, meaning, and style that speaks louder than trends.</p>
          </div>
          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
            <b>Community-Driven:</b>
            <p className='text-gray-800'>Our customers are our core. We value your voice, your support, and your style—every collection is inspired by you.</p>
          </div>
          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
            <b>Limited Drops, High Quality:</b>
            <p className='text-gray-800'>We believe in quality over quantity. Our collections are small-batch, well-crafted, and designed to last.</p>
          </div>
      </div>
